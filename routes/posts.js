...
const parallelContentDetector= require('../controllers/content-detector/parallelContentDetector')
//auth with facebook
router.post('/', upload.single('pic'), parallelContentDetector,postsController.addPost);
